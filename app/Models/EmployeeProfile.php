...
class EmployeeProfile extends Authenticatable
{
    ...
    public function removeRecords()
    {
        try{
            ...
            ObApplicationLog::where('action_by', $this->id)->delete();
            CtoApplicationLog::where('action_by', $this->id)->delete();
            ...
            $employee_ot_credits = EmployeeOvertimeCredit::where('employee_profile_id', $this->id)->get();

            foreach($employee_ot_credits as $employee_ot_credit){
            ...
            LegalInformation::where('personal_information_id', $this->personalInformation->id)->delete();
        }catch(\Exception $e){
                Helpers::errorLog($this->CONTROLLER_NAME, 'destroy', $e->getMessage());
        }
    }
