...
>>>>>>> origin/main
    ...
    public function test(Request $request)
    {
        try {
            ...
            if (isset($request_leave_type_id)) {
            ...
            $approve_count = count($filter_applications);

            return response()->json([
                'data' => [
                    'approved_count' => $approve_count,
                    'status' => $request_status,
                    'approved_leave_details' => LeaveApplicationResource::collection($filter_applications),
                ],
