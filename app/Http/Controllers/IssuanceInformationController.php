...
class IssuanceInformationController extends Controller
{
    ...
    {
        Log::channel('custom-info')->info('Issuance Information Controller ['.$module.']: message: '.$errorMessage);
    }

    protected function errorLog($module, $errorMessage)
    {
        Log::channel('custom-error')->error('Issuance Information Controller ['.$module.']: message: '.$errorMessage);
    }
}
