...
class OfficialBusinessResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'recommending_officer'              => $this->recommendingOfficer ? new EmployeeProfileRequestResource($this->recommendingOfficer) : null,
            'approving_officer'                 => $this->approvingOfficer ? new EmployeeProfileRequestResource($this->approvingOfficer) : null,
