...
class OfficialBusinessResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'personal_order_path'               => env("SERVER_DOMAIN")."/official_business/".$this->personal_order_path,
            'personal_order_size'               => $this->personal_order_size,
            'certificate_of_appearance'         => $this->certificate_of_appearance,
            'certificate_of_appearance_path'    => env("SERVER_DOMAIN")."/official_business/".$this->certificate_of_appearance_path,
