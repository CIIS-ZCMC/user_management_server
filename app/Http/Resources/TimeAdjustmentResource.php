...
class TimeAdjustmentResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            'id' => $this->id,
            'dtr_date' => $this->date,
            'first_in' => $this->first_in === null || $this->first_in === "" ? null : Carbon::parse($this->first_in)->format('H:i A'),
            'first_out' => $this->first_out === null || $this->first_out === "" ? null : Carbon::parse($this->first_out)->format('H:i A'),
            'second_in' => $this->second_in === null || $this->second_in === "" ? null : Carbon::parse($this->second_in)->format('H:i A'),
            'second_out' => $this->second_out === null || $this->second_out === "" ? null : Carbon::parse($this->second_out)->format('H:i A'),
