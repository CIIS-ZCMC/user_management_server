    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            "recommending_officer" => [
                ...
                "profile_url" => config("app.server_domain") . "/photo/profiles/" . $this->recommending->profile_url,
            ],
            "approving_officer" => [
                ...
                "profile_url" => config("app.server_domain") . "/photo/profiles/" . $this->approving->profile_url,
            ],
